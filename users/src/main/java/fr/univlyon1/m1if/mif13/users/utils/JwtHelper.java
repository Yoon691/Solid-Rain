package fr.univlyon1.m1if.mif13.users.utils;
...
public class JwtHelper {
     ...
     */
    public static String verifyToken(String token, String origin) throws NullPointerException, JWTVerificationException {
